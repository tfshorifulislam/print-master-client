...
const MobileScreenBottomNavbar = () => {
    return (
        <div
            className="fixed bottom-0 left-0 w-full flex justify-between items-center px-4 py-2 z-50 md:hidden bg-white text-black border-t border-gray-200 dark:bg-[#0b0b0d] dark:text-white dark:border-zinc-800">
